...
@Test  
     ...
     actions.click().build().perform();
	  ...
	  driver.findElement(By.xpath("//input[@type='text'][@name='$PpyWorkPage$ppyLabel']")).sendKeys("NBABatchCampaign65");
	  Thread.sleep(8000);
    ...
    //  driver.findElement(By.xpath(xpath1)).click( );
	   ...
	   // real code	 
		// failed code
	      driver.findElement(By.xpath("/html[1]/body[1]/div[3]/form[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[1]/div[2]/table[1]/tbody[1]/tr[1]/td[1]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[19]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/span[1]/button[1]")).click( );
		 Thread.sleep(6000);
		// failed code
  ...
  ///* old code 
	...
	////*	 new code fluent wait 
	   ...
	   ///--------------------------------------------------------------------------------------------------------------//	 
		 ...
		 FluentWait<WebDriver> wait = new FluentWait<WebDriver>(driver).withTimeout(6000, TimeUnit.SECONDS).pollingEvery(30, TimeUnit.SECONDS).ignoring(NoSuchElementException.class);
		 ...
		 public WebElement apply(WebDriver driver)
			...
			String getTextOnPage1 = "",getTextOnPage = "";
...
//			 WebElement element12 = driver.findElement(By.xpath("//span[text()='Stopped']"));
	//
//			 String getTextOnPage2 = element12.getText();
//			 
