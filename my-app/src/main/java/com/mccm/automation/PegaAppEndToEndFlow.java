...
public class PegaAppEndToEndFlow {

	@Test
	public static void RunNBACampaignEndToEndFlow() throws InterruptedException, AWTException {
		...
		driver.findElement(By.xpath(
				"(/html[1]/body[1]/div[2]/form[1]/div[3]/div[1]/table[1]/tbody[1]/tr[1]/td[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/div[1]/table[1]/tbody[1]/tr[1]/th[2]/div[1]/span[1]/a[1])"))
				.click();
		Thread.sleep(6000);
		driver.findElement(By.xpath(
				"//input[@type='text'][@name='$PpyFilterCriteria_pgRepPgSubSectionpzViewInstancesB_pxResults_pzViewInstances_1$ppyColumnFilterCriteria$gpyPurpose2$ppySearchText']"))
				.sendKeys("NBACampaignName");
		Thread.sleep(6000);
		...
		Thread.sleep(6000);
		element10.clear();
		element10.sendKeys("NBABatchCampaign88");
		Thread.sleep(6000);
		...
		Thread.sleep(6000);
		driver.findElement(By.xpath(
				"/html[1]/body[1]/div[3]/form[1]/div[3]/div[1]/table[1]/tbody[1]/tr[1]/td[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/table[1]/tbody[1]/tr[1]/td[2]/div[1]/table[1]/tbody[1]/tr[1]/th[2]/div[1]/span[1]/a[1]"))
				.click();
		Thread.sleep(6000);
		...
		driver.findElement(By.xpath("//*[@class='pi pi-close-circle']")).click();
		Thread.sleep(6000);
		driver.findElement(By.xpath("//input[@type='text'][@name='$PpyDisplayHarness$ppySearchText']"))
				.sendKeys("d_mccmsettings");
		Thread.sleep(6000);
		...
		while (itr.hasNext()) {
			...
			if (!mainWindow.equals(childWindow)) {
				...
				Thread.sleep(6000);
				driver.findElement(By.xpath(
						"//input[@type='checkbox'][@name='$PD_pzRunRecord$ppxRunWindow$gTABTHREAD1$ppxRunParameters$ppyFlushAll']"))
						.click();
				Thread.sleep(6000);
				Thread.sleep(6000);
...
//******PEGA Marketing StarTed  Here  **************************************************************//
		...
		while (itr5.hasNext()) {
			...
			if (!mainWindow5.equals(childWindow3)) {
				...
				driver.findElement(By.xpath("//input[@type='text'][@name='$PpyWorkPage$ppyLabel']"))
						.sendKeys("NBABatchCampaign88");
				Thread.sleep(8000);
				...
				js5.executeScript("arguments[0].scrollIntoView();", element1);
				Thread.sleep(8000);

				driver.findElement(By.xpath(
						"/html[1]/body[1]/div[3]/form[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[1]/div[2]/table[1]/tbody[1]/tr[1]/td[1]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/span[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/span[1]/button[1]"))
						.click();
				Thread.sleep(6000);

				driver.findElement(By.xpath("//button[text()='Apply']")).click();
				Thread.sleep(6000);
				driver.findElement(By.cssSelector("button[name='ContainerWithHeader_pyWorkPage.AudienceContainer_7']"))
						.click();
				Thread.sleep(6000);
				...
				// WebElement element2 =
				// driver.findElement(By.xpath("//span[text()='NBATestSegment']"));
				...
				WebElement checkbox = driver
						.findElement(By.xpath("//input[@type='checkbox'][@name='$PpyWorkPage$pEnableScheduling']"));
				checkbox.click();
				...
				WebElement element6 = driver.findElement(By.xpath("//span[text()='MCCM LC Outbound']"));
				js4.executeScript("arguments[0].scrollIntoView();", element6);
				Thread.sleep(6000);
				...
				driver.findElement(
						By.cssSelector("button[name='SimpleSelectorCardContent_DBTemplateMultiPg.Cards(7)_16']"))
						.click();
				...
				boolean searchIconPresence = driver.findElement(By.xpath("//button[text()='Add template']"))
						.isDisplayed();
