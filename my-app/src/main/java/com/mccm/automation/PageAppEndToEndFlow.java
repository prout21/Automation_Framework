...
public class PageAppEndToEndFlow {
  ...
  // @Test  
   //throws InterruptedException, AWTException
    public static void RunNBACampaignEndToEndFlow(String [] args) 
   {
	 ...
	 Thread.sleep(6000); 
	 element10.clear();
	 element10.sendKeys("NBABatchCampaign96");  	 
  	 Thread.sleep(6000);
...
//			String xpath5 = "(//i[@class='pi pi-caret-down'])[2]"; //(//i[@class='pi pi-caret-down'])[2]
			...
			try {
			 ...
			 Thread.sleep(8000);
			  driver.findElement(By.xpath("//input[@type='text'][@name='$PpyWorkPage$ppyLabel']")).sendKeys("NBABatchCampaign96");
			 Thread.sleep(8000);
				 ...
				 radio1.click( );								 
				  ...
				  driver.findElement(By.xpath("//span[text()='MCCM LC Outbound']")).click( );
			       Thread.sleep(6000);	
			   		 ...
			   		 driver.findElement(By.cssSelector("button[name='SimpleSelectorCardContent_DBTemplateMultiPg.Cards(7)_16']")).click( ); 			    Thread.sleep(6000);
