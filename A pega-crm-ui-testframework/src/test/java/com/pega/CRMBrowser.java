...
public class CRMBrowser extends PegaBrowser {
	...
	public CRMBrowser(CRMTestEnvironment testEnv) {
		super(testEnv);
		testEnv.setBrowser(this);
		configuration = this.testEnv.getConfiguration();
	}

	public PMPortal getPMPortal() {
		return this.pegaMarketingPortal;
	}
	...
	public void a_User_logs_in_with_Analyst_credentials() {
		...
		this.pegaMarketingPortal = getPortal(PMPortal.class);
		System.out.println("inside login"+this.pegaMarketingPortal);
	}
