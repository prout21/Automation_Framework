...
public class NewPhoneCall {
	...
	public void verifiy_left_nav_header_composites_dialogs_and_other_sections() {
		...
		Assert.assertTrue("Overview tab is not present", interaction.verifyElement(By.xpath("//h2[text()='Overview']")));
	...
	public void select_the_Stage_as_and_Rating_as_and_submit(String Stage, String Rating) throws Throwable {
		...
		PegaWebElement submitButton = interaction.findElement(By.xpath("//button[@data-test-id='2014121001163801314958']"));
		submitButton.click();
	}
