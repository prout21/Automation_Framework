...
public interface RuleInstance extends Frame {
	...
	static By RULE_NAME_TEXT_BOX_CAMP = By.xpath("//input[contains(@name,'pyLabel')]");
	static By ISSUE_SELECT_BOX = By.xpath(
			"//select[@id='IssueClass']|//select[contains(@name,'IssueClass')]|//select[@id='Issue']|//select[@id='pyIssue']|//select[@data-test-id='201505151039200044666168']");
	static By GROUP_SELECT_BOX = By.xpath(
			"//select[@id='GroupClass']|//select[contains(@name,'GroupClass')]|//select[@id='Group']|//select[@id='pyGroup']|//select[@data-test-id='201505151039200045667317']");
	...
	static By BUDGET_INPUT_BOX = By.xpath("//input[@id='Budget']|//input[contains(@name,'Budget')]|//input[@data-test-id='201505151410370306333761']");
